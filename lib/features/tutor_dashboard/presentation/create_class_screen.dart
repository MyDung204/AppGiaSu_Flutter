...
class _CreateClassScreenState extends ConsumerState<CreateClassScreen> {
  ...
  Widget build(BuildContext context) {
    String title = widget.classToEdit != null 
        ? 'Cập nhật lớp học' 
        : (widget.isGroup ? 'Mở lớp nhóm mới' : 'Mở lớp 1-kèm-1 mới');
          ...
          child: Column(
            children: [
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(labelText: 'Lịch học (VD: T2-T4 19h)', border: OutlineInputBorder()),
                validator: (v) => v == null || v.isEmpty ? 'Vui lòng nhập lịch học' : null,
              ),
               const SizedBox(height: 16),
